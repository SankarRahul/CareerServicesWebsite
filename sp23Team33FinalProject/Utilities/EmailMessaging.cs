...
namespace sp23Team33FinalProject.Utilities
{
    public static class EmailMessaging
    {
        public static void SendEmail(String emailSubject, String emailBody)
        {
            ...
            String strFromEmailAddress = "sp23Team33Kproject@gmail.com";
            ...
            String strPassword = "xxoqxnjriwtzpfhj";

            //This is the name of the business from which you are sending
            String strCompanyName = "Team 33 K Company";
            ...
            mm.Subject = "Team 33 - " + emailSubject;
            ...
            mm.To.Add(new MailAddress("sp23Team33Kproject@gmail.com"));
